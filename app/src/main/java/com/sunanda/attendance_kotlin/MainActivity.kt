...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    private fun requestAllPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this@MainActivity,
                        Manifest.permission.ACCESS_FINE_LOCATION) || ActivityCompat.shouldShowRequestPermissionRationale(this@MainActivity,
            ...
            ActivityCompat.requestPermissions(this@MainActivity, INITIAL_PERMS, INITIAL_REQUEST)
            Init()
        }
    }
